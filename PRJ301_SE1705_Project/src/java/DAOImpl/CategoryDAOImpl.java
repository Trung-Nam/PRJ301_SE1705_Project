...
public class CategoryDAOImpl extends DBContext implements ICategoryDAO {
    ...
    public List<Category> getAllCategorys() throws SQLException {
        ...
        String sql = "SELECT *FROM category_HE151090";
        try {
    ...
    public void addCategory(String categoryName) throws SQLException {
        // TODO Auto-generated method stub
        String sql = "INSERT INTO category_HE151090 (category_name) VALUES (?)";
        try {
            connection = getConnection();
            preparedStatement = connection.prepareStatement(sql);
    ...
    public void editCategory(Category category) throws SQLException {
        // TODO Auto-generated method stub
        String sql = "UPDATE category_HE151090 SET category_name = ? WHERE category_id = ?; ";
        try {
            connection = getConnection();
            preparedStatement = connection.prepareStatement(sql);
    ...
    public void deleteCategory(int categoryId) throws SQLException {
        // TODO Auto-generated method stub
        String sql = "DELETE FROM category_HE151090 WHERE category_id = ?";
        try {
            connection = getConnection();
            preparedStatement = connection.prepareStatement(sql);
    ...
    public Category getById(int id) throws SQLException {
        ...
        String sql = "SELECT * FROM category_HE151090 where category_id = ?";
        try {
            connection = getConnection();
            preparedStatement = connection.prepareStatement(sql);
...
//			dao.editCategory(new Category(1, "School life"));
    ...
    public Category getByName(String name) throws SQLException {
        Category category = null;
        String sql = "SELECT * FROM category_HE151090 where category_name = ?";
        try {
            connection = getConnection();
            preparedStatement = connection.prepareStatement(sql);
