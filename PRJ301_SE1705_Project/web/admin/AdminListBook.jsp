<%-- 
    Document   : AdminListBook
    Created on : Mar 5, 2023, 9:49:13 PM
    Author     : ASUS G731G
--%>
    ...
    <body>
        <div class="be-wrapper">
                            ...
                            <div class="left-sidebar-content">
                                <ul class="sidebar-elements">
                                    ...
                                    <li class="parent"><a href="dashboardHome.jsp"><i
                                        ...
                                        <ul class="sub-menu">
                                            <li class="active"><a href="list-book"></span>View All Book</a></li></li>
            ...
            <div class="be-content">
                <div class="page-head">
                    <h2 class="page-head-title">View All Books</h2>
                    <nav aria-label="breadcrumb" role="navigation">
                        <ol class="breadcrumb page-head-nav">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item"><a href="#">Admin Manager/</span></li>
                            <li class="breadcrumb-item active">View All Books</li>
                        </ol>
                    </nav>
                </div>
                                            ...
                                            <tbody>
                                                <c:forEach items="${listBook}" var="b">
                                                    <tr>
                                                        ...
                                                        <td class="align-middle">${b.bookTitle}</td>
                                                        <td class="align-middle">${b.author.authorName}</td>
                                                        <td class="align-middle">${b.brief}</td>
                                                        <td class="align-middle">${b.publisher.publisherName}</td>
                                                        <td class="align-middle">${b.category.categoryName}</td>
                                                        ...
                                                        <td class="text-right">
                                                            <div class="btn-group btn-hspace">
                                                                <button class="btn btn-secondary dropdown-toggle"
                                                                    ...
                                                                    Manager <span class="icon-dropdown mdi mdi-chevron-down"></span>
                                                                </button>
                                                                <div class="dropdown-menu" role="menu">
                                                                    <a class="dropdown-item" href="edit-book?id=${b.bookId}">Edit</a>
                                                                    <div class="dropdown-divider"></div>
                                                                    <a class="dropdown-item" href="delete-book?id=${b.bookId}">Remove</a>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
